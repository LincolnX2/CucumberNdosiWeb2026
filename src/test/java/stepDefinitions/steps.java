...
public class steps {
    ...
    @Given("i input the valid email {string}")
    public void i_input_the_valid_email  (String email){
        //driver.findElement(By.id("login-email")).sendKeys("email");
    }

    @Given("also input a valid password {string}")
    public void also_input_a_valid_password(String password) {
